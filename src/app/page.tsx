...
export default function Home() {
  return (
    <main className="flex min-h-dvh flex-col overflow-x-hidden bg-[radial-gradient(circle_at_70%_10%,#2c331a_0,transparent_28%),linear-gradient(145deg,#0d0f12,#08090b_65%)] px-[clamp(24px,5vw,80px)] py-7">
